...
\begin{exercise}
[Testing the Intertemporal Approach on Emerging Market Data]
...
\begin{exercise}[Permanent Income Versus  Beverage-Nelson Decomposition]
%This exercise is not in 1st edition 
The file 
endowment\_exercise\_Beverage\_Nelson.dat
%produced by running endowment_exercise_Beverage_Nelson.m  
...
\hline\hline
\end{tabular}}
%produced by running the stata code \verb?endowment_exercise_beverage_nelson.do ?
%in z:\uribe\book\endowment
...
of the 
{\it Beverage-Nelson decomposition}, which is given by 
 $y^c_t=y_t-\lim_{j\rightarrow  \infty}E_ty_{t+j}$.  (Hint: $y^c_t$ is a linear function of $\Delta y_t$ and $\Delta y_{t-1}$.)
\begin{quote}
{\bf Begin Answer: }
After some algebra, the Beverage-Nelson decomposition can be written as
\begin{equation*}
...
\end{equation*}
Then $E_t Y_{t+j} = R^j Y_{t}$ and the Beverage-Nelson cyclical component becomes:
\begin{equation*}
